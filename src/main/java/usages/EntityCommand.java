...
/** This interface represents an action item that represents a use case involving entities. */
public abstract class EntityCommand {
     ...
     */
    @NotNull public abstract Result execute();

    /** @return the place this EntityCommand saves and loads entities during execution. */
    @Nullable public EntityStorage getStorage() {
        return storage;
    }
     ...
     */
    public void setStorageSource(@Nullable EntityStorage storage) {
